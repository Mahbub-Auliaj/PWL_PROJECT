...
<div class="container" style="padding: 30px;">
    <div class="row justify-content-center align-items-center">
        <div class="card" style="width: 900px;">
            ...
            @endif
            <form method="POST" action="{{ route('transaksi_pinjam.store') }}" id="myform">
            @csrf
                <div class="form-group">
                    <label for="id_pinjaman">ID Transaksi</label>
                    <input type="text" name="id_pinjaman" class="form-control" id="id_pinjaman" aria-describedby="id_pinjaman" >
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="tanggal_kembali" class="form-control" id="tanggal_kembali" aria-describedby="tanggal_kembali" >
                </div>
                <div class="form-group">
